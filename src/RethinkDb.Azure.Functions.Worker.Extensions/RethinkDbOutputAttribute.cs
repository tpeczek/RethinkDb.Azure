...
{
    /// <summary>
    /// Attribute used to defines an output that binds to a RethinkDB table.
    /// </summary>
    public sealed class RethinkDbOutputAttribute : OutputBindingAttribute
    {
        ...
        /// <summary>
        /// Defines an output that binds to a RethinkDB table.
        /// </summary>
        ...
        public RethinkDbOutputAttribute(string databaseName, string tableName)
        {
